...
xlsx_styles = dict(
    black_bg_18=dict(font_name='Arial', bold=True, font_size=18,
                     font_color='White', pattern=1, fg_color='Black',
    ...
    left_12=dict(font_name='Arial', font_size=12, font_color='Black', border=1,
                 ...
                 text_wrap=True),
    left_bold_12=dict(font_name='Arial', font_size=12, bold=True,
                      border=1, pattern=1, align='left',
                      valign='vcenter', fg_color='White',
                      text_wrap=True),
    ...
    txt_left_12=dict(font_name='Arial', font_size=12, font_color='Black',
                  border=1, pattern=1, fg_color='White', align='left',
    ...
    ctr_black_bg_12=dict(font_name='Arial', bold=True, font_size=12,
                         ...
                         fg_color='Black', align='center', valign='vcenter',
                         text_wrap=True),
    ...
    ctr_light_steel_blue_bold_12=dict(font_name='Arial', font_size=12,
                            ...
                            text_wrap=True),
    ctr_lime_bold_12=dict(font_name='Arial', font_size=12,
                            bold=True, border=1, pattern=1, align='center',
                            valign='vcenter', fg_color='Lime',
                            text_wrap=True),
    ctr_yellow_bold_12=dict(font_name='Arial', font_size=12,
                            bold=True, border=1, pattern=1, align='center',
                            valign='vcenter', fg_color='Yellow',
                            text_wrap=True),
    ctr_silver_bold_12=dict(font_name='Arial', font_size=12,
                            bold=True, border=1, pattern=1, align='center',
                            valign='vcenter', fg_color='Silver',
                            text_wrap=True),
    ...
    left_black_bg_12=dict(font_name='Arial', font_size=12, border=1, pattern=1,
                          font_color='White', fg_color='Black', align='left',
                          valign='vcenter', text_wrap=True),
    ...
    float_right_black_bg_12=dict(font_name='Arial', font_size=12,
                                 ...
                                 fg_color='Black', num_format='#,##0.00',
                                 text_wrap=True),
    int_right_black_bg_12=dict(font_name='Arial', font_size=12,
                               font_color='White', border=1, pattern=1,
                               align='right', valign='vcenter',
                               fg_color='Black', num_format='#,##0',
                               text_wrap=True),
    txt_left_black_bg_12=dict(font_name='Arial', font_size=12,
                               font_color='White', border=1, pattern=1,
                               align='left', valign='vcenter', fg_color='Black',
                               text_wrap=True),
    ...
    txt_left_gray_bold_12=dict(font_name='Arial', font_size=12, bold=True,
                            border=1, pattern=1, align='left',
                            valign='vcenter', fg_color='#DCDCDC',
                            text_wrap=True),
