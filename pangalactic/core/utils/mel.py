...
mel_fields = dict(
    row=dict(range='int', definition='Row in MEL Report'),
    level=dict(range='int', definition='Level in Assembly Hierarchy'),
    name=dict(range='str', definition='System/Subsystem Name'),
    unit_mass=dict(range='float', definition='Unit Mass'),
    cold_units=dict(range='int', definition='Cold (Unpowered) Units'),
    hot_units=dict(range='int', definition='Hot (Powered) Units'),
    fhw_units=dict(range='int', definition='Flight Units'),
    fhw_spares=dict(range='int', definition='Flight Spares'),
    etu_qual_units=dict(range='int', definition='ETU/Qual Units'),
    em_edu_prototype_units=dict(range='int', definition='Units Used in Prototype'),
