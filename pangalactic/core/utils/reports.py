...
mel_columns = ['level', 'name', 'unit_mass', 'cold_units', 'hot_units',
    'flight_units', 'flight_spares', 'em_prototype', 'fh_mass_cbe',
    'fh_mass_contingency', 'fh_mass_w_contingency', 'fh_unit_power_cbe',
    'fh_total_power_cbe', 'fh_power_contingency', 'fh_power_w_contingency',
    'fh_peak_unit_power_cbe', 'fh_peak_total_power_cbe',
    'fh_peak_power_contingency', 'fh_total_power_w_contingency',
    'quiescent_total_power', 'quoted_price', 'composition',
    'additional_information', 'trl', 'vendor_maturity', 'location',
    'hve_temp', 'hve_pressure', 'hve_entry_load', 'hve_tid',
...
# black_bg_18, ctr_12, ctr_black_bg_12, ctr_gray_12,
# ctr_gray_bold_12, ctr_green_bold_12, ctr_green_12,
# ctr_turquoise_12, ctr_turquoise_bold_12,
# ctr_periwinkle_bold_12, ctr_pale_blue_12,
# ctr_pale_blue_bold_12, left_black_bg_12, left_gray_bold_12,
# left_pale_blue_12, left_pale_blue_bold_12, left_12,
# right_black_bg_12, right_12, right_gray_bold_12,
# turquoise_bold_12_rotated,

# DEPRECATED "write_mel" function ...
# Used xlwt to write a '.xls' file, which is now obsolete

# from xlwt import Workbook

# def write_mel(context, is_project=True, file_path='mel_writer_output.xls'):
    # """
    # Output a Master Equipment List (MEL)
    ...
    # sheet1.col(22).width = 11000
    # sheet1.col(23).width = 5000
    # sheet1.col(24).width = 2800
    # sheet1.col(25).width = 5000
    # sheet1.col(26).width = 5000
    # sheet1.col(27).width = 5000
    # sheet1.col(28).width = 5000
    # sheet1.col(29).width = 5000
    # sheet1.col(30).width = 3000
    # sheet1.col(31).width = 3000
    # sheet1.col(32).width = 3000
    # sheet1.col(33).width = 1800
    # sheet1.col(34).width = 1800
    # sheet1.col(35).width = 1800
    # sheet1.col(36).width = 1800
    # sheet1.col(37).width = 1800
    # sheet1.col(38).width = 1800
    # sheet1.col(39).width = 1800
    # sheet1.col(40).width = 3000
    # sheet1.col(41).width = 20000
    # sheet1.col(42).width = 4000
    # sheet1.col(43).width = 4000
    # sheet1.col(44).width = 4000
    # sheet1.col(45).width = 4000
    # sheet1.col(46).width = 4000
    # sheet1.col(47).width = 4000
    ...
    # # Title (row 0)
    # sheet1.row(title_row).height_mismatch = True
    # sheet1.row(title_row).height = 256*2
    # sheet1.write_merge(title_row, title_row, 0, 47,
                       # label='  MASTER EQUIPMENT LIST',
                       # style=black_bg_18)

    # # First row of headers (hrow1)
    # sheet1.row(hrow1).height_mismatch = True
    # sheet1.row(hrow1).height = 256*3
    # sheet1.write(hrow1, 0, 'LEVEL', style=ctr_pale_blue_bold_12)
    # # sheet1.write(hrow1, 1, 'NAME (Mission or Payload Name)',
                                        # # style=ctr_pale_blue_bold_12)
    # sheet1.write(hrow1, 2, 'UNIT\nMASS', style=ctr_pale_blue_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 3, 7, label='# OF UNITS',
                       # style=ctr_pale_blue_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 8, 10, label='FLIGHT HARDWARE MASS',
                       # style=ctr_pale_blue_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 11, 14,
                       # label='NOMINAL FLIGHT HARDWARE POWER',
                       # style=ctr_pale_blue_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 15, 18,
                       # label='PEAK FLIGHT HARDWARE POWER',
                       # style=ctr_gray_bold_12)
    # sheet1.write(hrow1, 19, 'QUIESCENT', style=ctr_gray_bold_12)
    # sheet1.write(hrow1, 22, 'ADDITIONAL INFORMATION',
                 # style=ctr_pale_blue_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 26, 29,
                       # label='HERITAGE VS ENVIRONMENTAL REQUIREMENTS',
                       # style=ctr_turquoise_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 33, 39,
                       # label='HERITAGE SUMMARY',
                       # style=ctr_turquoise_bold_12)
    # sheet1.write_merge(hrow1, hrow1, 42, 47,
                       # label='PRICE COST MODELING DATA',
                       # style=ctr_green_bold_12)

    # # Second row of headers (hrow2)
    # # Set height to accomodate wrapped column heading text
    # sheet1.write(hrow2, 0, "", style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 1, "Subassembly/Component", style=left_pale_blue_12)
    # sheet1.write(hrow2, 2, 'Unit Mass\n[kg]\n(CBE)',
                 # style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 3, 'Cold\nUnits', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 4, 'Hot\nUnits', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 5, 'Flight\nUnits', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 6, 'Flight\nSpares', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 7, 'EM\nPrototype', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 8, 'Total Mass\n[kg] (CBE)',
                 # style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 9, 'Contingency\n[%]', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 10, 'Total Mass\n[kg] with\nContingency\n(MEV)',
                 # style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 11, 'Unit\nPower [W]\n(CBE)',
                 # style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 12, 'Total\nPower [W]\n(CBE)',
                 # style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 13, 'Contingency\n(%)', style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 14, 'Total\nPower [W]\nwith\nContingency\n(MEV)',
                 # style=ctr_pale_blue_12)
    # sheet1.write(hrow2, 15, 'Unit\nPower [W]\n(CBE)', style=ctr_gray_12)
    # sheet1.write(hrow2, 16, 'Total\nPower [W]\n(CBE)', style=ctr_gray_12)
    # sheet1.write(hrow2, 17, 'Contingency\n(%)', style=ctr_gray_12)
    # sheet1.write(hrow2, 18, 'Total\nPower [W]\nwith\nContingency\n(MEV)',
                 # style=ctr_gray_12)
    # sheet1.write(hrow2, 19, 'Total Power\n[W] (CBE)', style=ctr_gray_12)
    # sheet1.write_merge(hrow1, hrow2, 20, 20, label='Quoted\nUnit\nPrice\n($K)',
                       # style=ctr_pale_blue_12)
    # sheet1.write_merge(hrow1, hrow2, 21, 21, label='Composition',
                       # style=ctr_pale_blue_12)
    # text = """(As applicable:  Vendor, make, model,
    # part #, volume, quote information,
    # notation of identical items,
    # instrument / component characteristics,
    # ETU approach...)"""
    # sheet1.write(hrow2, 22, text, style=ctr_pale_blue_12)
    # trl_text = """TECHNOLOGY
    # READINESS
    # LEVEL
    ...
    # TRL
    # """
    # sheet1.write_merge(hrow1, hrow2, 23, 23, label=trl_text,
                       # style=ctr_periwinkle_bold_12)
    # vendor_maturity_text = "VENDOR\nMATURITY\nDESCRIPTION"
    # sheet1.write_merge(hrow1, hrow2, 24, 24, label=vendor_maturity_text,
                                            # style=turquoise_bold_12_rotated)
    # sheet1.write_merge(hrow1, hrow2, 25, 25, label='LOCATION',
                                            # style=ctr_turquoise_bold_12)
    # sheet1.write(hrow2, 26, 'Temperature\n-X to Y',
                 # style=ctr_turquoise_12)
    # sheet1.write(hrow2, 27, 'Pressure\nX to Y [mPa]',
                 # style=ctr_turquoise_12)
    # sheet1.write(hrow2, 28, 'Entry Load\n< X [G]', style=ctr_turquoise_12)
    # sheet1.write(hrow2, 29, 'Radiation\nTID\n< X [krad-Si]',
                 # style=ctr_turquoise_12)
    # sheet1.write_merge(hrow1, hrow2, 30, 30,
                       # label='NEW TECHNOLOGY\nOR\nENGNRG CHANGE?',
                       # style=turquoise_bold_12_rotated)
    # sheet1.write_merge(hrow1, hrow2, 31, 31, label='OWNERSHIP?',
                       # style=turquoise_bold_12_rotated)
    # sheet1.write_merge(hrow1, hrow2, 32, 32, label='PERFORMANCE\nCHANGE?',
                       # style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 33, 'DESIGN', style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 34, 'MANUFACTURE', style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 35, 'SOFTWARE', style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 36, 'PROVIDER', style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 37, 'USE', style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 38, 'OPERATING\nENVIRONMENT',
                 # style=turquoise_bold_12_rotated)
    # sheet1.write(hrow2, 39, 'PRIOR USE', style=turquoise_bold_12_rotated)
    # sheet1.write_merge(hrow1, hrow2, 40, 40, label='REFERENCE\nMISSION(S)',
                       # style=turquoise_bold_12_rotated)
    # sheet1.write_merge(hrow1, hrow2, 41, 41,
                   # label='HERITAGE JUSTIFICATION and ADDITIONAL INFORMATION',
                   # style=ctr_turquoise_bold_12)
    # sheet1.write(hrow2, 42, 'Structure\nMass [kg]', style=ctr_green_12)
    # sheet1.write(hrow2, 43, 'Electronic\nComplexity\nFactor',
                                                # style=ctr_green_12)
    # sheet1.write(hrow2, 44, 'Structure\nComplexity\nFactor',
                                                # style=ctr_green_12)
    # sheet1.write(hrow2, 45, 'Electronic\nRemaining\nDesign\n(1.00 = 100%)',
                                                # style=ctr_green_12)
    # sheet1.write(hrow2, 46, 'Structure\nRemaining\nDesign\n(1.00 = 100%)',
                                                # style=ctr_green_12)
    # sheet1.write(hrow2, 47,
                 # 'Engineering\nComplexity\nMod. Level\n(Simple,\nNew)',
                 # style=ctr_green_12)
    # # Third row of headers (hrow3)
    # sheet1.write(hrow3, 1, "TOTAL FLIGHT HARDWARE",
                 # style=left_pale_blue_bold_12)
    ...
    # if is_project:
        # # context is Project, so may include several systems
        # project = context
        # sheet1.write(hrow1, 1, project.id, style=left_pale_blue_bold_12)
        # start_row = hrow3+1
        # for system in [psu.system for psu in project.systems]:
            # last_row = write_component_rows(sheet1, 1, start_row, system)
            # start_row = last_row + 1
    # else:
        # # context is Product -> a single system MEL
        # system = context
        # sheet1.write(hrow1, 1, system.name, style=left_pale_blue_bold_12)
        # write_component_rows(sheet1, 1, hrow3+1, system)
...
# def write_component_rows(sheet, level, row, component):
    ...
    # if level == 1:
        ...
        # data_style = right_black_bg_12
    # elif level == 2:
        # level_style = ctr_gray_bold_12
        # name_style = left_gray_bold_12
        # data_style = right_gray_bold_12
    # else:
        # level_style = ctr_12
        # name_style = left_12
        # data_style = right_12
    ...
    # # level-based indentation
    # spaces = '   ' * level
    # sheet.write(row, 1, spaces + component.name, style=name_style)
    # sheet.write(row, 8, mcbe, style=data_style)
    # sheet.write(row, 9, ctgcy_m, style=data_style)
    # sheet.write(row, 10, mmev, style=data_style)
    # sheet.write(row, 12, pcbe, style=data_style)
    # sheet.write(row, 13, ctgcy_P, style=data_style)
    # sheet.write(row, 14, pmev, style=data_style)
    # if component.components:
        # next_level = level + 1
        # comps = [acu.component for acu in component.components]
        # for comp in comps:
            # row = write_component_rows(sheet, next_level, row, comp)
    # return row
