...
def create_test_project():
    ...
    test_project = [
        ...
        dict(
            ...
            comment='Magic Twanger Quantum Commications System',
            public=True,
            creator='test:steve',
            create_datetime=NOW,
            modifier='test:steve',
        ...
        dict(
            _cname='HardwareProduct',
            oid='test:h2g2.propsubsystem0',
            id='H2G2-Prop',
            id_ns='test',
            product_type='pgefobjects:ProductType.propulsion_system',
            owner='H2G2',
            name='Propulsion',
            description='H2G2 multi-modal propulsion subsystem',
            data_elements=deepcopy(test_data_elements),
            parameters=deepcopy(test_parms),
            public=True,
            creator='test:whorfin',
        ...
        dict(
            _cname='Acu',
            oid='test:H2G2:acu-sc0-propsys',
            id='acu-sc0-propsys',
            id_ns='test',
            name='H2G2 Rocinante Propulsion Subsystem',
            assembly='test:spacecraft0',
            component='test:h2g2.propsubsystem0',
            reference_designator='Propulsion',
        ...
        dict(
            ...
            id='acu-1',
            id_ns='test',
            name='Oscillation Overthruster in Rocinante Prop Subsystem',
            assembly='test:h2g2.propsubsystem0',
        ...
        dict(
            ...
            id='acu-2',
            id_ns='test',
            name='Infinite Improbability Drive in Rocinante Prop Subsystem',
            assembly='test:h2g2.propsubsystem0',
        ...
        dict(
            ...
            id='acu-3',
            id_ns='test',
            name='Photon Drive in Rocinante Prop Subsystem',
            assembly='test:h2g2.propsubsystem0',
        ...
        dict(
            ...
            modifier='test:steve',
            name='Launch',
            oid='test:Launch.H2G2',
            owner='H2G2',
            parameters={
              'duration': 300.0},
            sub_activity_of='test:Mission.H2G2',
        ...
        dict(
            ...
            modifier='test:steve',
            name='Propulsion',
            oid='test:Propulsion.H2G2',
            owner='H2G2',
            parameters={
              'duration': 1200.0},
            sub_activity_of='test:Mission.H2G2',
            sub_activity_sequence=2),
        dict(
            _cname='Activity',
            activity_type='pgefobjects:ActivityType.Cycle',
            create_datetime='2024-08-23 00:00:00',
            creator='test:steve',
            id='H2G2-Orbit',
            mod_datetime='2024-08-23 00:00:00',
            ...
            owner='H2G2',
            sub_activity_of='test:Mission.H2G2',
            sub_activity_sequence=3),
        dict(
            _cname='Activity',
            activity_type='pgefobjects:ActivityType.Operation',
            create_datetime='2024-08-23 00:00:00',
            creator='test:steve',
            id='H2G2-Science-Data-Acquisition',
            mod_datetime='2024-08-23 00:00:00',
            modifier='test:steve',
        ...
        dict(
            ...
            create_datetime='2024-08-23 00:00:00',
            creator='test:steve',
            id='H2G2-Science-Data-Xmit',
            mod_datetime='2024-08-23 00:00:00',
            modifier='test:steve',
            name='Science Data Xmit',
            oid='test:SciDataXmit.H2G2',
            owner='H2G2',
            parameters={
              'duration': 1200.0},
            sub_activity_of='test:Orbit.H2G2',
