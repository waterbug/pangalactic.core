...
def create_test_project():
    ...
    test_project = [
        ...
        dict(
            ...
            reference_designator='PropSys-1',
        ...
        dict(
            ...
            reference_designator='PropSys-2',
            product_type_hint='pgefobjects:ProductType.propulsion_system',
            creator='test:steve',
            create_datetime=NOW,
            modifier='test:steve',
        ...
        dict(
            ...
            reference_designator='PropSys-3',
            product_type_hint='pgefobjects:ProductType.propulsion_system',
            creator='test:steve',
            create_datetime=NOW,
            modifier='test:steve',
        ...
        dict(
            ...
            reference_designator='CompSys-1',
        ...
        dict(
            ...
            reference_designator='CommSys-1',
        ...
        dict(
            ...
            reference_designator='PowerSys-1',
            product_type_hint='pgefobjects:ProductType.instrument',
            creator='test:steve',
            create_datetime=NOW,
            modifier='test:steve',
        ...
        dict(
            ...
            assembly='test:twanger',
            component='test:mr_fusion',
            reference_designator='PowerSys-2',
            product_type_hint='pgefobjects:ProductType.power_system',
            creator='test:steve',
            create_datetime=NOW,
            modifier='test:steve',
...
related_test_objects = [
    ...
    dict(
        ...
        reference_designator='Thermal System',
        creator='test:steve',
        create_datetime=NOW,
        modifier='test:steve',
        mod_datetime=NOW
