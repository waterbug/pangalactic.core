...
def create_test_project():
    ...
    test_project = [
        ...
        dict(
            ...
            rqt_type='performance',
            rqt_constraint_type='maximum',
            rqt_maximum_value=5000.0,
            rqt_units='kg',
...
related_test_objects = [
    ...
    dict(
     ...
     dict(
        ...
        version_sequence=0,
        owner='test:OTHER',
        name='MCAD Model of The Other Spacecraft',
        of_thing='test:spacecraft3',
        model_definition_context='gsfc:Discipline.mechanical',
        type_of_model='pgefobjects:ModelType.MCAD',
        description='MCAD Model, v0, of Other Spacecraft',
        creator='test:steve',
        create_datetime=NOW,
        modifier='test:steve',
        mod_datetime=NOW
     ...
     dict(
        ...
        id_ns='test',
        name='Other v3 MCAD v0 STEP File 0',
        description='Other v3 MCAD v0 STEP File 0',
        of_object='test:spacecraft3.mcad.model.0',
        mime_type='application/step',
        # (same file as used for 'test:spacecraft0')
        url='vault://Other_0_MCAD_0_R0_File0.step',
        creator='test:steve',
        create_datetime=NOW,
        modifier='test:steve',
        mod_datetime=NOW),
    ...
    dict(
        ...
        id_ns='test',
        name='Infinite Improbability Drive in Other Spacecraft',
        assembly='test:spacecraft3',
        component='test:iidrive',
        reference_designator='Prop-2',
        creator='test:steve',
    ...
    dict(
        ...
        id_ns='test',
        name='Photon Drive in Other Spacecraft',
        assembly='test:spacecraft3',
        component='test:photon_drive',
        reference_designator='Prop-3',
        creator='test:steve',
    ...
    dict(
        ...
        id_ns='test',
        name='Bambleweeny Sub-Meson Brain in Other Spacecraft',
        assembly='test:spacecraft3',
        component='test:computer',
        reference_designator='Comp-1',
        creator='test:steve',
    ...
    dict(
        ...
        id_ns='test',
        name='Magic Twanger in Other Spacecraft',
        assembly='test:spacecraft3',
        component='test:twanger',
        reference_designator='Comm-1',
        creator='test:steve',
    ...
    dict(
        ...
        id_ns='test',
        name='Thermal System in Other Spacecraft',
        assembly='test:spacecraft3',
