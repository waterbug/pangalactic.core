...
class OrbTest(unittest.TestCase):
    ...
    # def test_19_1_load_parameters_from_old_format(self):
        ...
        # """
        # parms_path = os.path.join('marvin_test', 'parameters.json')
        # parms_bkup_path = os.path.join('marvin_test',
    ...
    # def test_19_2_load_data_elements_from_old_format(self):
        ...
        # file in the old format and convert them to the new format.
        # """
        # des_path = os.path.join('marvin_test', 'data_elements.json')
        # des_bkup_path = os.path.join('marvin_test',
    ...
    # def test_24_compute_margin(self):
        ...
        # perf_rqt = orb.get('test:OTHER:Spacecraft-Mass')
        # nte = perf_rqt.rqt_maximum_value
    ...
    # def test_25_compute_requirement_margin(self):
        ...
        # expected = ('test:OTHER:system-1', 'm', nte, perf_rqt.rqt_units, margin)
        # self.assertEqual(expected, value)
