...
{   '_cname': 'ParameterDefinition',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Specified Power requirement for a component'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'base_parameters': 'P',
    'description':
        'Sum of the power requirements of components in an assembly'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'base_parameters': 'P',
    'generating_function': 'pangalactic.core.parametrics.get_assembly_parameter',
    'description': u'Current Best Estimate of Power requirement computed as the sum of the power requirements of known components in an assembled part'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Power Contingency: percentage of Current Best Estimate of Power designated to cover contingencies'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'description': u'Maximum Expected Value of Power (CBE * [1 + Ctgcy])'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'description': u'Power Margin ([NTE-CBE]/NTE)'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Not To Exceed (NTE) value for Power:  the Maximum Expected Value (MEV) of Power should not exceed this value'},
