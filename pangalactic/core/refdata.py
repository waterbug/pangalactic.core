...
{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.m_total',
    'id': 'm_total',
    'name': 'Mass (Assembly)',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'dimensions': 'mass',
    'range_datatype': 'float',
    'computed_by_default': True,
    'generating_function':
        'pangalactic.core.parametrics.get_assembly_parameter',
    'base_parameters': 'm',
    'description': u'Sum of the masses of components in an assembly'},
...
{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.R_total',
    'id': 'R_total',
    'name': 'Data Rate (Assembly)',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    'create_datetime': epoch,
    'mod_datetime': '2018-05-25 00:00:00',
    ...
    'generating_function':
        'pangalactic.core.parametrics.get_assembly_parameter',
    'base_parameters': 'R_D',
    'description': u'Sum of the data rates of components in an assembly'},
...
{   '_cname': 'ParameterDefinition',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Specified electrical power requirement for a component'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.P_total',
    'id': 'P_total',
    'name': 'Power (Assembly)',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'base_parameters': 'P',
    'description':
        'Sum of the electrical power requirements of components in an assembly'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.m_CBE',
    'id': 'm_CBE',
    'name': 'Mass CBE',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'variable_name': 'm',
    'mode_name': 'Assembly',
    'parameter_context': 'CBE',
    'range_datatype': 'float',
    'computed_by_default': True,
    'generating_function': 'pangalactic.core.parametrics.get_assembly_parameter',
    'base_parameters': 'm',
    'description': u'Current Best Estimate of Mass, computed as the sum of the masses of known components in an assembled part'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.m_ctgcy',
    'id': 'm_ctgcy',
    'name': 'Mass Ctgcy',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'mod_datetime': epoch,
    'variable_name': 'm',
    'parameter_context': 'Contingency',
    'dimensions': 'percent',
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Mass Contingency: percentage of Current Best Estimate of Mass designated to cover contingencies'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.m_MEV',
    'id': 'm_MEV',
    'name': 'Mass MEV',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'mod_datetime': epoch,
    'variable_name': 'm',
    'parameter_context': 'MEV',
    'dimensions': 'mass',
    'range_datatype': 'float',
    'computed_by_default': True,
    'generating_function': 'pangalactic.core.parametrics.get_mev',
    'base_parameters': 'm_CBE, m_ctgcy',
    'description': u'Maximum Expected Value of Mass (CBE * [1 + Ctgcy])'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.m_margin',
    'id': 'm_margin',
    'name': 'Mass Margin',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'mod_datetime': epoch,
    'variable_name': 'm',
    'parameter_context': 'Margin',
    'dimensions': 'percent',
    'range_datatype': 'float',
    'computed_by_default': True,
    'generating_function': 'pangalactic.core.parametrics.get_margin',
    'base_parameters': 'm_NTE, m_CBE',
    'description': u'Mass Margin ([NTE-CBE]/NTE)'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.Cost_total',
    'id': 'Cost_total',
    'name': 'Assembly Cost',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'computed_by_default': True,
    'generating_function': 'pangalactic.core.parametrics.get_assembly_parameter',
    'base_parameters': 'Cost',
    'description': u'Total Cost of all items in an assembly'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.P_CBE',
    'id': 'P_CBE',
    'name': 'Power CBE',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'base_parameters': 'P',
    'generating_function': 'pangalactic.core.parametrics.get_assembly_parameter',
    'description': u'Current Best Estimate of Power requirement computed as the sum of the electrical power requirements of known components in an assembled part'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.P_ctgcy',
    'id': 'P_ctgcy',
    'name': 'Power Ctgcy',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Power Contingency: percentage of Current Best Estimate of electrical power designated to cover contingencies'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.P_MEV',
    'id': 'P_MEV',
    'name': 'Power MEV',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'description': u'Maximum Expected Value of electrical power requirement (CBE * [1 + Ctgcy])'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.P_margin',
    'id': 'P_margin',
    'name': 'Power Margin',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'description': u'Electrical Power Margin ([NTE-CBE]/NTE)'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.R_CBE',
    'id': 'R_CBE',
    'name': 'Data Rate CBE',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'base_parameters': 'R_D',
    'generating_function': 'pangalactic.core.parametrics.get_assembly_parameter',
    'description': u'Current Best Estimate of data rate requirement computed as the sum of the data rate requirements of known components in an assembled part'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.R_ctgcy',
    'id': 'R_ctgcy',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Data Rate Contingency: percentage of Current Best Estimate of data rate designated to cover contingencies'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.R_MEV',
    'id': 'R_MEV',
    'name': 'Data Rate MEV',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'description': u'Maximum Expected Value of Data Rate (CBE * [1 + Ctgcy])'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.R_margin',
    'id': 'R_margin',
    ...
    'description': u'Data Rate Margin ([NTE-CBE]/NTE)'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.m_NTE',
    'id': 'm_NTE',
    'name': 'Mass NTE',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Not To Exceed (NTE) value for Mass:  the Maximum Expected Value (MEV) of Mass should not exceed this value'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.P_NTE',
    'id': 'P_NTE',
    'name': 'Power NTE',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'range_datatype': 'float',
    'computed_by_default': False,
    'description': u'Not To Exceed (NTE) value for Electrical Power requirement:  the Maximum Expected Value (MEV) of electrical power requirement should not exceed this value'},

{   '_cname': 'ParameterDefinition',
    'oid': 'pgef:ParameterDefinition.R_NTE',
    'id': 'R_NTE',
    'name': 'Data Rate NTE',
    'owner': 'pgefobjects:PGANA',
    'creator': 'pgefobjects:admin',
    ...
    'range_datatype': 'int',
    'computed_by_default': False,
    'description': u'Not To Exceed (NTE) value for Data Rate:  the Maximum Expected Value (MEV) of Data Rate should not exceed this value'},
