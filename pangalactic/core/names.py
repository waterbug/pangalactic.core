...
attr_ext_alias = {
    ...
    'Requirement': [
        ...
        ('rqt_level', 'Level'),
        ('rqt_compliance', 'Compliance'),
        ('rqt_constraint_type', 'Constraint Type'),
        ('rqt_dimensions', 'Dimensions'),
        ('rqt_maximum_value', 'Maximum'),
        ('rqt_minimum_value', 'Minimum'),
        ('rqt_tolerance', 'Tolerance'),
        ('rqt_tolerance_lower', 'Lower Tolerance'),
        ('rqt_tolerance_upper', 'Upper Tolerance'),
        ('description', 'Text'),
        ('verification_method', 'Verification Method')
        ]
    }
